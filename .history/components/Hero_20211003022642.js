        ...
        >
          ...
          >
            ...
            >
                    ...
                    return (
                      <h1>
                        {text.split("").map((char, i) => {
                          const key = `${i}`;
                          return (
                            <span key={key} style={{ color: "#24B47E" }}>
                              {char}
                            </span>
                          );
                        })}
              ...
              <Badge color="green">Student only</Badge>
              {"    "}
              <Badge color="green">Beginner friendly</Badge>
              {"    "}
              ...
              >
                ...
                <Image  src="https://pipedream.com/s.v0/app_1dBhP3/logo/96"
              </Stack>
            </Box>
          </Box>
        </Box>
